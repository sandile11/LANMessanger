...
public class client extends javax.swing.JFrame {
  ...
  //  byte [] arr1  = new byte[1024];
    String tmp;
    Thread send;
    Thread receivetThread,stateThread,delayThread;
    public client() throws SocketException {
        initComponents();
        datagramSocket = new DatagramSocket(5004);
        datagramSocket1 = new DatagramSocket(5001);
    ...
    private boolean delaytime(DatagramPacket dp ){
            ...
            public void run() {
                ...
                try {
                    ...
                    */
                    ...
                    if(delaytime(statepPacket)== false){
                    ...
                    if(tmp.contains("5002o")){
                       System.out.println("receive are you 5002o");
                    ...
                    //System.out.println(new String(datagramPacket1.getData()));}
                        ...
                        System.out.println("receive are you online");
